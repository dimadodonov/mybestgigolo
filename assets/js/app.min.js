...
const App = {
  ...
  auth() {
    ...
    $document.on('click', '.page__auth-form-next .btn', function () {
      ...
      $('#box-' + dataBox).siblings('.page__auth-form-box').hide();
      $('#box-' + dataBox).show();
    });
  },
  ...
  admin() {
    $document.on('click', '.admin__profile-item-type span', function () {
      ...
      if ($('.admin__profile-item-type-wrap').hasClass('on')) {
        $('.admin__profile-item-type-wrap').find('.admin__profile-item-type').removeClass('on');
      }

      $(this).toggleClass('on').siblings('.admin__profile-item-type-wrap').toggleClass('on');
    });
    $document.on('click', '.admin__profile-item-type-wrap.on .admin__profile-item-type-option', function () {
  ...
  filter() {
    ...
    $('.select-text').on('click', function () {
      $(this).parent('.filter__item.select').siblings().removeClass('active');
    ...
    if ($('.pricing__switch').length) {
      $('.pricing__switch-item').on('click', function () {
        if ($('.pricing__switch-item').hasClass('pricing__switch-active')) {
          $('.pricing__switch-item').removeClass('pricing__switch-active');
        }
        ...
        if ($('.pricing__grid-item-price .price').hasClass('price-active')) {
          $('.pricing__grid-item-price .price').hide().removeClass('price-active');
        }

        $('.pricing__grid-item-price small').text($switchTitle);
        $('.pricing__grid-item-price .price-' + $switch).show().addClass('price-active');
      });
  ...
  popup() {
    ...
    function model_note() {
      if (localStorage.getItem('model_note') !== null) {
        ...
        $('.profile__quote').show();
        $('#popup__note textarea').val(localStorage.getItem('model_note'));
...
App.Components = function () {
  function _init() {
    console.log('Site Components Init'); // App.Components.Menu.init();
  }
